...
public class ADRES_GIRIS extends JInternalFrame {
	...
	public ADRES_GIRIS() {
		...
		txtkodu.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				{
					try {
						sonuc = oac.aDRES_MSSQL.kod_ismi(txtkodu.getText());
				...
				{
					try {
						sonuc = oac.aDRES_MYSQL.kod_ismi(txtkodu.getText());
					} catch (ClassNotFoundException e1) {
						e1.printStackTrace();
					} catch (SQLException e1) {
						e1.printStackTrace();
	...
	private static void hisset(String siralama,String arama) 
	{
		...
		if (CONNECTION.adrdizinbilgi.han_sql.equals("MS SQL"))
		{
			rs = oac.aDRES_MSSQL.adres(siralama,arama);
		}
		else
		{
			rs = oac.aDRES_MYSQL.adres(siralama,arama);
		}
	      ...
	      try
	      {
			  ...
			  os.close();
	    	   ...
	    	   if (CONNECTION.caridizinbilgi.han_sql.equals("MS SQL"))
	    		{
	    		   oac.aDRES_MSSQL.sil(txtkodu.getText(),txtunvan.getText());
	    		   oac.aDRES_MSSQL.adres_kayit(txtkodu.getText(), txtunvan.getText(),txtadres1.getText(), txtadres2.getText(), 
			    ...
			    {
			    	oac.aDRES_MYSQL.sil(txtkodu.getText(),txtunvan.getText());
		    		oac.aDRES_MYSQL.adres_kayit(txtkodu.getText(), txtunvan.getText(),txtadres1.getText(), txtadres2.getText(), 
		    			   txtsemt.getText(), txtsehir.getText(), txtvd.getText(), txtvn.getText(), txtfax.getText(), txttel1.getText(),
		    			   txttel2.getText(), txtozel.getText(),txtyetkili.getText(), txtmail.getText(),txtn1.getText(), txtn2.getText(),
		    			   txtn3.getText(), fis, txttel3.getText(), txtaciklama.getText(), chcsms.isSelected(), chcmail.isSelected(),
		    			   txtoz1.getText(), txtoz2.getText(),txtweb.getText(), txtpkodu.getText(), GLOBAL.KULL_ADI);
