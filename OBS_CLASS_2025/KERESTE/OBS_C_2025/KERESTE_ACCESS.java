...
public class KERESTE_ACCESS {
	...
	{
		return _IKereste.baslik_bak(baslik, ordr, jkj,  k1, k2, f1, f2, t1, t2,dURUM,e1,e2);
	}
	...
	{
		return _IKereste.grp_rapor( gruplama,sstr_2, sstr_4, kur_dos,  qwq6, qwq7, qwq8, k1, k2, s1, s2, jkj,  t1, t2, sstr_5, sstr_1,orderBY,dURUM,ko1,ko2,dpo,grup,e1,e2);
	}
	...
	{
		return _IKereste.ort_diger_kodu(yu, qwq6, qwq7, m1, m2, s1, s2, k1, k2, t1, t2, kurkod, kurc, iu,hANGI,kurlu);
	}
	...
	public void ker_kons_degis(String kons , String yenikons,int satir,lOG_BILGI lBILGI, DIZIN_BILGILERI dBILGI) throws ClassNotFoundException, SQLException 
	{
		_IKereste.ker_kons_degis(kons, yenikons,satir);
		for ( ILOGGER  _Logger : _Logger )
			_Logger.Logla(lBILGI, dBILGI);
	}
