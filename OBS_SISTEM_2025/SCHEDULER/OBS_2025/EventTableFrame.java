...
public class EventTableFrame extends JFrame {
  ...
  public static class SearchPanel extends RPanel {
    ...
    public SearchPanel(Window pw, JTable tt, EventMemory tm, EventTableModel ttm) {
      ...
      search_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "search", 190, 200, 80, 21);
      export_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "export", 280, 200, 80, 21);
      import_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "import", 370, 200, 80, 21);
      sync_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "sync", 460, 200, 80, 21);
      delete_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "delete", 550, 200, 80, 21);
      sure_button = new RButton(this, Color.blue, Color.red, Color.red, "sure?", 550, 200, 80, 21);
      close_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "close", 910, 200, 80, 21);
    ...
    public void mouseClicked(MouseEvent e) {
      if (close_button.mouse_clicked(e)) {
        ...
        if (event_table.getSelectedRows().length > 0) {
          ...
          result_text = "delete " + Integer.toString(event_table.getSelectedRows().length) + " item(s)?";
        }
        else {
          result_text = "select events first!";
        }
        this.repaint();
        return;
      }
        ...
        result_text = Integer.toString(sel_rows.length) + " item(s) deleted!";
        event_memory.save();
      }
    }
    ...
    private void import_() {
      ...
      if (result_text.length() == 0) {
        result_text = Integer.toString(k) + " item(s) imported!";
      }
      this.repaint();
      event_memory.save();
    }
    ...
    private void search() {
      ...
      result_text = Integer.toString(found_rows) + " item(s) found.";
      this.repaint();
    }
  }
