...
import obs.menu.mode.LightDarkMode;
...
import obs.menu.mode.ToolBarAccentColor;
...
//        {"Special Pages", "Blank page", "Faq", "Invoice", "Profile", "Pricing", "Timeline"},
    ...
    private final String headerName = "OBS SISTEM";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/obs/icon/png/logo.png")));
