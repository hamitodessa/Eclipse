...
public class FILTRE extends JDialog {
					...
					public void mouseClicked(MouseEvent e) {
						if (e.getClickCount() == 2) 
						{
							...
							try {
								hsp = new HESAP_PLN();
								hsp.show();
								txtkodu.setText( GLOBAL.hsp_hsp_kodu);
							} catch (Exception e1) {
								e1.printStackTrace();
							}
						}
					...
					public void mouseClicked(MouseEvent e) {
						if (e.getClickCount() == 2) 
						{
							...
							try {
								hsp = new HESAP_PLN();
								hsp.show();
								txtilk.setText( GLOBAL.hsp_hsp_kodu);
							} catch (Exception ex) {
							// TODO Auto-generated catch block
							}
					...
					public void mouseClicked(MouseEvent e) {
						if (e.getClickCount() == 2) 
						{
							...
							try {
								hsp = new HESAP_PLN();
								hsp.show();
								txtson.setText( GLOBAL.hsp_hsp_kodu);
							} catch (Exception ex) {}
						}
					}
				});
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							txtdvz.setText( GLOBAL.hsp_hsp_kodu);
							//isimoku_dvz();
						} catch (Exception ex) {}
					}
				}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							txtgh1.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception ex) {}
					}
				}
			});
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							txtgh2.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception ex) {}
					}
				}
			});
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							txtch1.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception ex) {}
					}
				}
			});
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							txtch2.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception ex) {}
					}
				}
			});
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_7.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							txtZzzzzzzzzzzz.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_31.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_34.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_41.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_49.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_59.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
				...
				public void mouseClicked(MouseEvent e) {
					if (e.getClickCount() == 2) 
					{
						...
						try {
							hsp = new HESAP_PLN();
							hsp.show();
							textField_60.setText( GLOBAL.hsp_hsp_kodu);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
					}
	...
	if (GLOBAL.filtre_sayfa == 0)
	{
	 ...
	 public void isimoku_ekstre()  {
		    ...
		    {
		    	hpl = new String[3];
				hpl = CARI_ISIM_OKU.isim(txtkodu.getText());
	 ...
	 public void isimoku_dvz()  {
		    ...
		    {
		    	hpl = new String[3];
				hpl = CARI_ISIM_OKU.isim(txtdvz.getText());
