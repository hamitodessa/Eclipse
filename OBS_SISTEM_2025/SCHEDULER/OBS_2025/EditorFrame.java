...
public class EditorFrame extends JFrame {
  ...
  public static class EditorPanel extends RPanel {
    ...
    public EditorPanel(Event t, Event ot, Window pw, boolean b, boolean s) {
      ...
      byear_rc = rc_array[4];
      rc_array = render_event_entry("End", 18, 150, t.get_end_UTC_ms());
      ehour_rc = rc_array[0];
      emin_rc = rc_array[1];
      eday_rc = rc_array[2];
      ...
      c_pub_priv_rc = new RComponent(this, bg_color, Color.orange, t.get_vcal_class(),
          1, 0, 1, sf, "", 195, 700, 180, rel_font_size);
      ...
      //buttons
      descr_button = new RButton(this, Color.gray, Color.orange, Color.red, "description", 410, 700, 375, rel_font_size);
      color_button = new RButton(this, event.get_renderer_color(), Color.orange, Color.red, "colour", 802, 700, 180, rel_font_size);
