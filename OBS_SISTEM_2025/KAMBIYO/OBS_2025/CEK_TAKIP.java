...
public class CEK_TAKIP extends JInternalFrame {
	...
	public CEK_TAKIP() {
		...
		panel_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Cek No", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_1_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Islem", TitledBorder.LEADING, TitledBorder.TOP, null, null));
