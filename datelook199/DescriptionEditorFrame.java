...
public class DescriptionEditorFrame extends JFrame {
  ...
  public static class ButtonPanel extends RPanel {
    ...
    public ButtonPanel(Window pw, EditorFrame ef, JEditorPane ep, String s, Color c) {
      ...
      copy_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "copy", 570, 200, 91, 24);
      cut_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "cut", 670, 200, 91, 24);
      paste_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "paste", 770, 200, 91, 24);
      close_button = new RButton(this, new Color(0, 50, 100), Color.orange, Color.red, "close", 900, 200, 91, 24);
    }
