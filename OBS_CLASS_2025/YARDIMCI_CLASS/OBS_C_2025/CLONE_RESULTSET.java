...
public class CLONE_RESULTSET {
	...
	public static ResultSet cloneResultSet(ResultSet originalResultSet) throws SQLException {
		...
		for (int i = 1; i < columnCount+1; i++) {
			columnNames[i] = originalResultSet.getMetaData().getColumnName(i );
			
		}
		cnames = columnNames ;
		while (originalResultSet.next()) {
			String[] rowData = new String[columnCount+1];
			for (int i = 1; i <= columnCount; i++) {
				rowData[i] = originalResultSet.getString(i);
			}
			dataRows.add(rowData);
		}
		return new ClonedResultSet(dataRows, columnNames);
	}
	private static class ClonedResultSet implements ResultSet {
		...
		public String getString(int columnIndex) throws SQLException {
			return dataRows.get(currentIndex)[columnIndex];
