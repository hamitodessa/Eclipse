...
public class ManualResultSet {
    private final ResultSetMetaData metaData;
    private final List<Object[]> data;
    private int currentRow = -1;

    public ManualResultSet(ResultSetMetaData metaData) {
...
public class CustomResultSetMetaData implements ResultSetMetaData {
    ...
    public CustomResultSetMetaData(String[] columnNames, String[] columnTypes) {
        this.columnNames = columnNames;
        this.columnTypes = columnTypes;
    }

    // Implement other methods of ResultSetMetaData
    // ...
