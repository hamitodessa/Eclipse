...
public class H_PLANI extends JInternalFrame {
	...
	public H_PLANI()  {
		...
		txtkodu.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				{
					try {
						sonuc = oac.cARI_HESAP_MSSQL.kod_ismi(txtkodu.getText());
				...
				{
					try {
						sonuc = oac.cARI_HESAP_MYSQL.kod_ismi(txtkodu.getText());
					} catch (ClassNotFoundException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					} catch (SQLException e1) {
	...
	private static void hisset(String arama) 
	{
		...
		if (CONNECTION.caridizinbilgi.han_sql.equals("MS SQL"))
		{
			rs = oac.cARI_HESAP_MSSQL.hsp_pln(arama);
		}
		else
		{
			rs = oac.cARI_HESAP_MYSQL.hsp_pln(arama);
		}
	      ...
	      try
	      {
			...
			if ( imagePanel.getImage()) 
			{
			  ...
			  os.close();
	    	   ...
	    	   if (CONNECTION.caridizinbilgi.han_sql.equals("MS SQL"))
	    		{
	    		   oac.cARI_HESAP_MSSQL.hsp_sil(txtkodu.getText());
	    		   oac.cARI_HESAP_MSSQL.hpln_kayit(txtkodu.getText(), txtunvan.getText(), txtkarton.getText(), txthcinsi.getText(),GLOBAL.KULL_ADI);
	    		   oac.cARI_HESAP_MSSQL.hpln_detay_kayit(txtkodu.getText()
			    ...
			    {
			    	oac.cARI_HESAP_MYSQL.hsp_sil(txtkodu.getText());
			    	oac.cARI_HESAP_MYSQL.hpln_kayit(txtkodu.getText(), txtunvan.getText(), txtkarton.getText(), txthcinsi.getText(),GLOBAL.KULL_ADI);
				    oac.cARI_HESAP_MYSQL.hpln_detay_kayit(txtkodu.getText()
				    		, txtyetkili.getText(), txtadres1.getText(), txtadres2.getText()
				    		, txtsemt.getText(), txtsehir.getText(), txtvd.getText(), txtvn.getText()
		                    , txttel1.getText(), txttel2.getText(), txttel3.getText(), txtfax.getText(), txto1.getText()
		                    , txto2.getText(), txto3.getText(), txtweb.getText(), txtmail.getText()
