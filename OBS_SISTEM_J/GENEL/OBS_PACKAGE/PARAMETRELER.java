...
import OBS_PACKAGE.ColorChooserButton.ColorChangedListener;
...
public class PARAMETRELER   extends JInternalFrame   {
	...
	private void doldur()  {
		...
		deger = GLOBAL.setting_oku("CARI_DVZ_CEV").toString();
		...
		deger = GLOBAL.setting_oku("CARI_KARTON").toString();
		...
		deger = GLOBAL.setting_oku("CARI_MIZ_GRUP").toString();
		...
		/// ***********************************************IRS
		deger = GLOBAL.setting_oku("STK_ISR_ABILGI").toString();
		...
		deger = GLOBAL.setting_oku("STK_IRS_BASLIK").toString();
		...
		deger = GLOBAL.setting_oku("STK_IRS_DETAY").toString();
		...
		deger = GLOBAL.setting_oku("STK_IRS_FIR_BILGI").toString();
		comboBox_1.setSelectedItem(deger);
		
		deger = GLOBAL.setting_oku("STK_IRS_GIRIS").toString();
		...
		deger = GLOBAL.setting_oku("STK_ENV_KUS").toString();
		if (deger.equals("-1"))
		{
		...
		deger = GLOBAL.setting_oku("STK_ENV_YAZ").toString();
		if (deger.equals("-1"))
		{
		...
		deger = GLOBAL.setting_oku("STK_IMA_BAS_TAR").toString();
		dateChooser.setDate(TARIH_CEVIR.tarih(deger));
		//************************* GUNLUK ***********************************
		deger = GLOBAL.setting_oku("GUN_KON").toString();
		if (deger.equals("-1"))
		{
		...
		deger = GLOBAL.setting_oku("GUN_SER_KON").toString();
		if (deger.equals("-1"))
		{
		...
		deger = GLOBAL.setting_oku("GUN_SER_KON_ZAM").toString();
		...
		deger = GLOBAL.setting_oku("KAM_SEN_GIR").toString();
		textField_7.setText(deger);
		deger = GLOBAL.setting_oku("KAM_SEN_CIK").toString();
		textField_8.setText(deger);
		
		deger = GLOBAL.setting_oku("KAM_SAT_KOP").toString();
			parts = deger.split(",");
		...
		deger = GLOBAL.setting_oku("KAM_SAT_YAP").toString();
			parts = deger.split(",");
		...
		//*********************PROGRAM *************************************
		deger = GLOBAL.setting_oku("PRG_PARA").toString();
		...
		deger = GLOBAL.setting_oku("PRG_YENILE").toString();
			parts = deger.split(",");
		...
		deger = GLOBAL.setting_oku("PRG_SIL").toString();
			parts = deger.split(",");
		...
		deger = GLOBAL.setting_oku("PRG_GORUNUM").toString();
	...
	public static  void kayit()
	{
		try {
		String deger = "" ;
		GLOBAL.setting_yaz("CARI_DEKONT_BAKIYE_GOSTER", chckbxNewCheckBox.isSelected() ?  "0" : "-1");
		GLOBAL.setting_yaz("CARI_ARAMA", lblNewLabel_3.getText());
		
		deger = (chckbxNewCheckBox_2_2.isSelected() ?  "E" : "" ) + "," + (chckbxNewCheckBox_2_1_1.isSelected() ?  "E" : "" ) + "," + (comboBox_2_1.getSelectedItem());
		GLOBAL.setting_yaz("CARI_DEK_Y_FIS", deger);
		
		GLOBAL.setting_yaz("CARI_DVZ_CEV", lblNewLabel_3_3.getText());
		
		GLOBAL.setting_yaz("CARI_EKSTRE", lblNewLabel_3_4.getText());
		
		
		GLOBAL.setting_yaz("CARI_GUN_IS", lblNewLabel_3_5.getText());
		
	
		GLOBAL.setting_yaz("CARI_HES_BAK", lblNewLabel_3_6.getText());
		
		
		GLOBAL.setting_yaz("CARI_HSPPLN", lblNewLabel_3_7.getText());
		
		deger = (chckbxNewCheckBox_2_2_1.isSelected() ?  "E" : "" ) + "," + (chckbxNewCheckBox_2_1_1_1.isSelected() ?  "E" : "" ) + "," + (comboBox_2_1_1.getSelectedItem());
		GLOBAL.setting_yaz("CARI_HSPPLN_CAG", deger);
		
		
		GLOBAL.setting_yaz("CARI_KARTON", lblNewLabel_3_8.getText());
		
		
		GLOBAL.setting_yaz("CARI_MIZAN", lblNewLabel_3_9.getText());
		
		deger = textField.getText();
		GLOBAL.setting_yaz("CARI_MIZ_GRUP", deger);
		//************************************************ STOK FAT*******************
		
		GLOBAL.setting_yaz("STK_FAT_ABILGI", lblNewLabel_3_10.getText());
		GLOBAL.setting_yaz("STK_FAT_BASLIK", lblNewLabel_3_1_1.getText());
		GLOBAL.setting_yaz("STK_FAT_DETAY", lblNewLabel_3_2_1.getText());
		deger =  comboBox.getItemAt(comboBox.getSelectedIndex());
		GLOBAL.setting_yaz("STK_FAT_FIR_BILGI", deger);
		GLOBAL.setting_yaz("STK_FAT_GIRIS",lblNewLabel_3_2_1_1.getText());
		deger = textField_1.getText();
		GLOBAL.setting_yaz("STK_FAT_SATIR", deger);
		GLOBAL.setting_yaz("STK_STOK_KONTROL", chckbxNewCheckBox_1.isSelected() ?  "0" : "-1");
		GLOBAL.setting_yaz("STK_YAZI_ILE",lblNewLabel_3_2_1_1_1.getText());
		//************************************************ STOK IRS*******************
		
		GLOBAL.setting_yaz("STK_IRS_ABILGI", lblNewLabel_3_10_1.getText());
		
		
		GLOBAL.setting_yaz("STK_IRS_BASLIK", lblNewLabel_3_1_1_1.getText());
		
	
		GLOBAL.setting_yaz("STK_IRS_DETAY", lblNewLabel_3_2_1_2.getText());
		
		deger =  comboBox_1.getItemAt(comboBox_1.getSelectedIndex());
		GLOBAL.setting_yaz("STK_IRS_FIR_BILGI", deger);
		
		
		GLOBAL.setting_yaz("STK_IRS_GIRIS",  lblNewLabel_3_2_1_1_2.getText());
		
		deger = textField_2.getText();
		GLOBAL.setting_yaz("STK_IRS_SATIR", deger);
		//************************************************ STOK STK
		GLOBAL.setting_yaz("STK_RAPORLAMA", lblNewLabel_3_10_1_1.getText());
		
		GLOBAL.setting_yaz("STK_ENV_KUS", chckbxNewCheckBox_1_1.isSelected() ?  "0" : "-1");
		
		GLOBAL.setting_yaz("STK_ENV_YAZ", chckbxNewCheckBox_1_2.isSelected() ?  "0" : "-1");
		
		GLOBAL.setting_yaz("STK_IMA_BAS_TAR", TARIH_CEVIR.tarih_dt_ddMMyyyy(dateChooser));
		
		//***********************GUNLUK ******************************
		
		GLOBAL.setting_yaz("GUN_KON", chckbxNewCheckBox_1_3.isSelected() ?  "0" : "-1");
		
		deger = textField_3.getText();
		GLOBAL.setting_yaz("GUN_KON_ZAM", deger);
		
		GLOBAL.setting_yaz("GUN_SER_KON", chckbxNewCheckBox_1_3_1.isSelected() ?  "0" : "-1");
		
		deger = textField_4.getText();
		GLOBAL.setting_yaz("GUN_SER_KON_ZAM", deger);
		
		//*****************KAMBIYO***************************
		deger = textField_5.getText();
		GLOBAL.setting_yaz("KAM_CEK_GIR", deger);
		
		deger = textField_6.getText();
		GLOBAL.setting_yaz("KAM_CEK_CIK", deger);
		
		deger = textField_7.getText();
		GLOBAL.setting_yaz("KAM_SEN_GIR", deger);
		
		deger = textField_8.getText();
		GLOBAL.setting_yaz("KAM_SEN_CIK", deger);
		...
		GLOBAL.setting_yaz("KAM_SAT_KOP", deger);
		...
		GLOBAL.setting_yaz("PRG_KAYDET", deger);
		...
		GLOBAL.setting_yaz("PRG_SIL", deger);
		
		deger = comboBox_2.getItemAt(comboBox_2.getSelectedIndex());
		GLOBAL.setting_yaz("PRG_GORUNUM", deger);
		...
		GLOBAL.setting_yaz("PRG_GRID_RENK", deger);
		
				OBS_SIS_ANA_CLAS. gridcolor =  colorChooser.getSelectedColor();
