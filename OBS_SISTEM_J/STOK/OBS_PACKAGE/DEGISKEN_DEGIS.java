...
public class DEGISKEN_DEGIS extends JInternalFrame {
	...
	public static void kaydet()
	{
    	...
    	ResultSet yrs =null ;
        		...
        		{
        			rs = oac.sTOK_MSSQL.urun_kod_degisken_ara("AGID_Y", "ANA_GRUP", "ANA_GRUP_DEGISKEN", cmbAna.getItemAt(cmbAna.getSelectedIndex()).toString());
        			yrs = oac.sTOK_MSSQL.urun_kod_degisken_ara("AGID_Y", "ANA_GRUP", "ANA_GRUP_DEGISKEN", cmbyAna.getItemAt(cmbyAna.getSelectedIndex()).toString());

        		}
        		else
        		{
        			rs = oac.sTOK_MYSQL.urun_kod_degisken_ara("AGID_Y", "ANA_GRUP", "ANA_GRUP_DEGISKEN", cmbAna.getItemAt(cmbAna.getSelectedIndex()).toString());
        			yrs = oac.sTOK_MYSQL.urun_kod_degisken_ara("AGID_Y", "ANA_GRUP", "ANA_GRUP_DEGISKEN", cmbyAna.getItemAt(cmbyAna.getSelectedIndex()).toString());
    	    	...
    	    	else
    	    	{
     	      	...
     	      	if (CONNECTION.fatdizinbilgi.han_sql.equals("MS SQL"))
     			{
     	    		rs = oac.sTOK_MSSQL.urun_kod_degisken_ara("ALID_Y", "ALT_GRUP", "ALT_GRUP_DEGISKEN",  cmbAlt.getItemAt(cmbAlt.getSelectedIndex()).toString());
     	    		yrs = oac.sTOK_MSSQL.urun_kod_degisken_ara("ALID_Y", "ALT_GRUP", "ALT_GRUP_DEGISKEN",  cmbyAlt.getItemAt(cmbyAlt.getSelectedIndex()).toString());
    			}
     			else
     			{
     	    		rs = oac.sTOK_MYSQL.urun_kod_degisken_ara("ALID_Y", "ALT_GRUP", "ALT_GRUP_DEGISKEN",  cmbAlt.getItemAt(cmbAlt.getSelectedIndex()).toString());
     	    		yrs = oac.sTOK_MYSQL.urun_kod_degisken_ara("ALID_Y", "ALT_GRUP", "ALT_GRUP_DEGISKEN",  cmbyAlt.getItemAt(cmbyAlt.getSelectedIndex()).toString());
     			}
     	      	if (!rs.isBeforeFirst() ) {      		
    	    	}
    	    	else
    	    	...
    	    	else
    	    	{
     	      	...
     	      	if (CONNECTION.fatdizinbilgi.han_sql.equals("MS SQL"))
    			{
    	    		oac.sTOK_MSSQL.degisken_degistir(anagrp,altgrp,yanagrp,yaltgrp);
    			}
    			else
    			{
    				oac.sTOK_MYSQL.degisken_degistir(anagrp,altgrp,yanagrp,yaltgrp);
    			}
		//*************************
	...
	private void alt_grup_doldur(JComboBox<String> anabox,JComboBox<String> altbox)
	{
		...
		if (CONNECTION.fatdizinbilgi.han_sql.equals("MS SQL"))
		{
			rs = oac.sTOK_MSSQL.urun_kod_degisken_ara("AGID_Y", "ANA_GRUP", "ANA_GRUP_DEGISKEN", anabox.getItemAt(anabox.getSelectedIndex()).toString());
			if (!rs.isBeforeFirst() ) {
			}
			else
			{
		...
		{
			rs = oac.sTOK_MYSQL.urun_kod_degisken_ara("AGID_Y", "ANA_GRUP", "ANA_GRUP_DEGISKEN", anabox.getItemAt(anabox.getSelectedIndex()).toString());
			if (!rs.isBeforeFirst() ) {
			}
			else
			{
