...
public class Notifications {
    ...
    private final main.java.raven.toast.util.NotificationHolder notificationHolder = new main.java.raven.toast.util.NotificationHolder();
    ...
    protected main.java.raven.toast.ui.ToastNotificationPanel createNotification(Type type, String message) {
        
    	main.java.raven.toast.ui.ToastNotificationPanel toastNotificationPanel = new main.java.raven.toast.ui.ToastNotificationPanel();
    ...
    public class NotificationAnimation {
		...
		public NotificationAnimation(Type type, Location location, long duration, String message) {
            ...
            main.java.raven.toast.ui.ToastNotificationPanel toastNotificationPanel = createNotification(type, message);
