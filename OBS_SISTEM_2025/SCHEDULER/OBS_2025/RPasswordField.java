 ...
 */
/**
 *  Rene's PasswordField.<br>
 *  This PasswordField scales proportional to its parent panel.
 */
public class RPasswordField extends JPasswordField implements RInterface {
  ...
  /**
   *  Constructor for the RPasswordField object
   *
   * @param  pw   password to initialize the field
   ...
   */
  public RPasswordField(String pw, int x, int y, int w, int fs) {
    super(pw);
    x_relative = x;
    y_relative = y;
    w_relative = w;
  ...
  /**
   *  Parent Panel resized<br>
   *  resizes the RPasswordField
   */
  public void parent_panel_resized() {
    Component parent = this.getParent();
    Graphics2D g2 = (Graphics2D) parent.getGraphics();
    if (g2 != null) {
      Font font = new Font("SansSerif", Font.PLAIN, font_size_relative * parent.getWidth() / 1000);
