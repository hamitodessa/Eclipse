...
public class SimpleButtonBar extends javax.swing.JPanel {
    ...
    public void initEvent(JFrame fram) {
     ...
     private void initComponents() {
        ...
        cmdClose = new titlebar.Buttont();
        cmdResize = new titlebar.Buttont();
        cmdMinimize = new titlebar.Buttont();
        ...
        JLabel qazJLabel = new JLabel("fdsfsdfsdfdsfsd");
        qazJLabel.setText("fdsfsdfsdfdsfsd");
        qazJLabel.setForeground(Color.WHITE);
        qazJLabel.setSize(300,18);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            	.addGap(0, 0, 0)
                .addComponent(qazJLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(qazJLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
    ...
    private titlebar.Buttont cmdClose;
    private titlebar.Buttont cmdMinimize;
    private titlebar.Buttont cmdResize;
