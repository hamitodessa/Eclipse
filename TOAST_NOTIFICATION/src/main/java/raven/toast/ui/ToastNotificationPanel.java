package main.java.raven.toast.ui;
...
public class ToastNotificationPanel extends JPanel {
    ...
    private main.java.raven.toast.Notifications.Type type;
    ...
    public void set(main.java.raven.toast.Notifications.Type type, String message) {
        this.type = type;
    ...
    public Color getDefaultColor() {
        if (type == main.java.raven.toast.Notifications.Type.SUCCESS) {
            return Color.decode("#2e7d32");
        } else if (type == main.java.raven.toast.Notifications.Type.INFO) {
            return Color.decode("#0288d1");
        } else if (type == main.java.raven.toast.Notifications.Type.WARNING) {
